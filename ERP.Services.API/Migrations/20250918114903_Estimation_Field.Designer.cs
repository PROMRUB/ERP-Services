...
namespace ERP.Services.API.Migrations
{
    ...
    [Migration("20250918114903_Estimation_Field")]
    partial class Estimation_Field
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Services.API.Entities.ProductEntity", b =>
                {
                    ...
                    b.Property<decimal?>("AdministrativeCostEst")
                        .HasColumnType("numeric")
                        .HasColumnName("administrative_cost_est");

                    b.Property<Guid?>("BusinessId")
                        .HasColumnType("uuid")
                        .HasColumnName("business_id");

                    b.Property<decimal?>("BuyUnitEst")
                        .HasColumnType("numeric")
                        .HasColumnName("buyunit_est");

                    b.Property<decimal?>("CostEst")
                        .HasColumnType("numeric")
                        .HasColumnName("cost_est");

                    b.Property<decimal?>("CostInhand")
                        .HasColumnType("numeric")
                        .HasColumnName("cost_inhand");

                    b.Property<decimal?>("CostLastPO")
                        .HasColumnType("numeric")
                        .HasColumnName("cost_last_po");

                    b.Property<string>("CurrencyEst")
                        .HasColumnType("text")
                        .HasColumnName("currency_est");
                    ...
                    b.Property<decimal?>("ExchangeRateEst")
                        .HasColumnType("numeric")
                        .HasColumnName("exchangerate_est");

                    b.Property<decimal?>("ImportDutyEst")
                        .HasColumnType("numeric")
                        .HasColumnName("import_duty_est");

                    b.Property<string>("IncortermEst")
                        .HasColumnType("text")
                        .HasColumnName("incoterm_est");
                    ...
                    b.Property<decimal?>("WHTEst")
                        .HasColumnType("numeric")
                        .HasColumnName("wht_po");
            ...
            modelBuilder.Entity("ERP.Services.API.Entities.QuotationEntity", b =>
                {
                    ...
                    b.Property<bool>("IsSpecialPrice")
                        .HasColumnType("boolean")
                        .HasColumnName("is_special_price");
            ...
            modelBuilder.Entity("ERP.Services.API.Entities.QuotationProductEntity", b =>
                {
                    ...
                    b.Property<decimal>("AdministrativeCosts")
                        .HasColumnType("numeric")
                        .HasColumnName("administrative_costs");
                    ...
                    b.Property<decimal>("CostEstimatePercent")
                        .HasColumnType("numeric")
                        .HasColumnName("cost_estimate_percent");

                    b.Property<decimal>("CostEstimateProfit")
                        .HasColumnType("numeric")
                        .HasColumnName("cost_estimate_profit");

                    b.Property<decimal>("CostEstimateProfitPercent")
                        .HasColumnType("numeric")
                        .HasColumnName("cost_estimate_profit_percent");
            ...
            modelBuilder.Entity("ERP.Services.API.Entities.QuotationProjectEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("EthSaleMonth")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("eth_sale_month");
            ...
            modelBuilder.Entity("ERP.Services.API.Entities.PaymentAccountEntity", b =>
                {
                    b.HasOne("ERP.Services.API.Entities.BankBranchEntity", "BankBranchEntity")
                        .WithMany()
                        .HasForeignKey("BankBranchId");

                    b.HasOne("ERP.Services.API.Entities.BankEntity", "BankEntity")
                        .WithMany()
                        .HasForeignKey("BankId");

                    b.Navigation("BankBranchEntity");
            ...
            modelBuilder.Entity("ERP.Services.API.Entities.QuotationEntity", b =>
                {
                    b.HasOne("ERP.Services.API.Entities.BusinessEntity", "Business")
                        .WithMany()
